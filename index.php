...
<body>
            ...
            <span class="topber__title--text">
                <?php
                    if ( 'dashboard' == $id ) {
                        ...
                        echo "Salesmans";
                    } elseif ( 'addMedicen' == $id ) {
                        echo "Add Medicine";
                    } elseif ( 'allMedicen' == $id ) {
                        echo "Medicine";
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-home"></i> Pharmacy Management System</h3>
    ...
    echo " active";
            ...
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole || 'salesman' == $sessionRole) {?>
                <!-- For Admin, Manager, Pharmacist-->
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addMedicen' == $id ) {
                                                                            echo " active";
                                                                        }?>">
                    <a href="index.php?id=addMedicen"><i id="left" class="fas fa-user-plus"></i>Add Medicine</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allMedicen' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allMedicen"><i id="left" class="fas fa-user"></i>All Medicine</a>
            </li>
        </ul>
    ...
    <section class="main">
        <div class="container">
                    ...
                    <div class="total">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="total__box text-center">
                                    <h1><?php
                                            $query = "SELECT COUNT(*) totalMedicen FROM medicen;";
                                                $result = mysqli_query( $connection, $query );
                                                $totalMedicen = mysqli_fetch_assoc( $result );
                                            echo $totalMedicen['totalMedicen'];
                                            ?></h1>
                                    <h2>Medicine</h2>
                                </div>
                            </div>
            ...
            <!-- ---------------------- medicien ------------------------ -->
            <div class="medicen">
                <?php if ( 'allMedicen' == $id ) {?>
                    <div class="allMedicen">
                        <div class="main__table">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $getMedicen = "SELECT * FROM medicen";
                                            $result = mysqli_query( $connection, $getMedicen );

                                        while ( $medicen = mysqli_fetch_assoc( $result ) ) {?>

                                        <tr>
                                             <td>
                                                <center><img class="rounded-circle" width="40" height="40" src="assets/img/<?php echo $medicen['avatar']; ?>" alt=""></center>
                                            </td>
                                            <td><?php printf( "%s", $medicen['Mname'] );?></td>
                                            <td><?php printf( "%s", $medicen['MFdate'] );?></td>
                                            <td><?php printf( "%s", $medicen['EXdate'] );?></td>
                                            <td><?php printf( "%s", $medicen['Rate'] );?></td>
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole || 'salesman' == $sessionRole ) {?>
                                                <!-- For Admin, Manager, Pharmacist-->
                                                <td><?php printf( "<a href='index.php?action=editMedicen&id=%s'><i class='fas fa-edit'></i></a>", $medicen['id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='index.php?action=deletemedicen&id=%s'><i class='fas fa-trash'></i></a>", $medicen['id'] )?></td>
                                            <?php }?>
                                        </tr>
                 ...
                 <?php }?>
                 <?php if ( 'addMedicen' == $id ) {?>
                    <div class="addMedicen">
                        <div class="main__form">
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="Mname" placeholder="Medicen Name" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="date" name="MFdate" placeholder="Manufacturing date" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-envelope"></i>
                                            <input type="date" name="EXdate" placeholder="Expiry" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                    ...
                                    <input type="hidden" name="action" value="addMedicen">
                                    <div class="col col-12">
                                        <input type="submit" value="Submit">
                                    </div>
                                </div>
                ...
                <?php if ( 'editMedicen' == $action ) {
                        $medicenID = $_REQUEST['id'];
                        $selectmedicen = "SELECT * FROM medicen WHERE id ='{$medicenID}'";
                        $result = mysqli_query( $connection, $selectmedicen );

                    $medicen = mysqli_fetch_assoc( $result );?>
                    <div class="addMedicen">
                        <div class="main__form">
                            <div class="main__form--title text-center">Update Medicine</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="Mname" placeholder="Medicen Name" value="<?php echo $medicen['Mname']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="date" name="MFdate" placeholder="manufacturing date" value="<?php echo $medicen['MFdate']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-envelope"></i>
                                            <input type="date" name="EXdate" placeholder="Expiry" value="<?php echo $medicen['EXdate']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-phone-alt"></i>
                                            <input type="number" name="Rate" placeholder="Rate" value="<?php echo $medicen['Rate']; ?>" required>
                                        </label>
                                    </div>
                                    <input type="hidden" name="action" value="updateMedicen">
                                    <input type="hidden" name="id" value="<?php echo $medicenID; ?>">
                                    <div class="col col-12">
                                        <input type="submit" value="Update">
                                    </div>
                                </div>
                ...
                <?php if ( 'deletemedicen' == $action ) {
                        $medicenID = $_REQUEST['id'];
                        $deletemedicen = "DELETE FROM medicen WHERE id ='{$medicenID}'";
                        $result = mysqli_query( $connection, $deletemedicen );
                        header( "location:index.php?id=allMedicen" );
                }?>
            </div>
